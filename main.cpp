...
int main(int argc, char *argv[])
{
    ...
    Mat src = imread("/Users/mansovic./CLionProjects/CPROJECT/r.png");
    ...
    // Get the duration of the code execution
    ...
    namedWindow("harris corners detected");
    imshow("harris corners detected", corner);
